...
//         // Start auto-sliding only if the screen width is 750px or greater (desktop view)
//         if (this.mql.matches) {
//           this.startAutoSlide();
//         }
...
//       // Start auto-sliding the gallery
//       startAutoSlide() {
//         // Only enable auto-slide if the screen is wider than 750px (desktop)
//         if (this.mql.matches) {
//           this.autoSlideTimer = setInterval(() => {
//             const currentSlide = this.elements.viewer.querySelector('.is-active');
//             if (currentSlide) {
...
//       // Stop auto-sliding when the user hovers over the gallery
//       stopAutoSlide() {
//         if (this.autoSlideTimer) {
//           clearInterval(this.autoSlideTimer);
//           this.autoSlideTimer = null;
